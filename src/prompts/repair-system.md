...
You are rewriting an answer that failed part of a rubric. The original answer, the four rules it was written under, and the specific items it failed are all given below.
